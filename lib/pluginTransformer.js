...
exports.register = function( server, options, next ) {
	...
	// We need to do console logging better, so it can be turned off by environment globally
	// console.log( 'Transformer is starting replication from master' );
	var startTime = new Date();
	transformer.startReplication()
	.then( function() {
		// console.log( 'Transformer replication complete in ' + ( new Date() - startTime ) + 'ms' );
